...
- Adicionar novos livros com:
  - Título, autor, resumo
  - Imagem de capa personalizada (ou placeholder automático)
  - Avaliação com estrelas (de 0 a 5)
  - Comentário pessoal
  - Citação favorita

- Editar ou excluir livros já cadastrados
